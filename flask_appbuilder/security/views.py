...
class UserModelView(ModelView):
    ...
    base_permissions = ['can_list', 'can_show', 'can_edit', 'can_action', 'can_delete', 'can_add',
                        'can_userinfo', "resetmypassword", "resetpasswords", "userinfoedit"]
    label_columns = {
    ...
    add_columns = ["first_name", "last_name", "username", "active", "email", "roles", "speciality", "user_type"]
    edit_columns = ["first_name", "last_name", "username", "active", "email", "roles", "speciality", "user_type"]
    user_info_title = lazy_gettext("Your user information")

    add_form_extra_fields = {
        'speciality': SelectField('Speciality', choices=get_choices('speciality'),
                                  validators=[validators.DataRequired()],
                                  widget=CustomizeSelect2Widget(extra_classes="")),
        'user_type': SelectField('User Type', choices=get_choices('user_type'),
                                  validators=[validators.DataRequired()],
                                  widget=CustomizeSelect2Widget(extra_classes="")),
    }
