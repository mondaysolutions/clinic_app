...
class BaseFormView(BaseView):
    ...
    def _get_edit_widget(self, form=None, exclude_cols=None, widgets=None, submit_name=None):
...
class BaseCRUDView(BaseModelView):
    ...
    def _get_edit_widget(self,  pk, form, actions=None, exclude_cols=None, widgets=None, submit_name='Save'):
        exclude_cols = exclude_cols or []
        widgets = widgets or {}
        actions = actions or self.actions
        widgets["edit"] = self.edit_widget(
